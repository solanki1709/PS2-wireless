...
void bot_motion()
{
    ...
    {
      int bot_pwm=map(mright_X,0,128,200,500);
      setPWM(bot_pwm);
      bot_right();  
    ...
    {
      int bot_pwmt=map(mright_X,0,-127,200,500);
      setPWM(bot_pwm);
      bot_left();
    ...
    { 
      int bot_pwm=map(mleft_Y,0,128,200,500);
      setPWM(bot_pwm);
      bot_forward();
    ...
    {
      int bot_pwm=map(mleft_Y,0,-127,200,500);
      setPWM(bot_pwm);
      bot_backward();
